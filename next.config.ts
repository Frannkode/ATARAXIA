...
// Headers de seguridad estándar (Requisitos no funcionales, sección
// Seguridad) — no incluye Content-Security-Policy: una CSP estricta
// necesita nonces para los scripts de hidratación de Next.js y probarse
// a fondo (rompe fácil en silencio), no vale el riesgo sin esa inversión.
